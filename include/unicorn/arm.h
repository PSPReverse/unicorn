...
// Callback function for tracing cpsr writes (for uc_hook_intr())
// @user_data: user data passed to tracing APIs.
typedef bool (*uc_cb_cpsr_write_t)(struct uc_struct *uc, uint64_t addr, uint32_t cpsr, void *user_data);
