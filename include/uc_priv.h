...
#define UC_MODE_ARM_MASK    (UC_MODE_ARM|UC_MODE_THUMB|UC_MODE_LITTLE_ENDIAN|UC_MODE_ARM_NO_MMU|UC_MODE_MCLASS \
...
enum uc_hook_idx {
    ...
    UC_HOOK_ARM_CP_WRITE_IDX,
    UC_HOOK_ARM_CP_READ_IDX,
    UC_HOOK_ARM_CPSR_WRITE_IDX,
